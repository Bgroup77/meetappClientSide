...
// Should be replace with meetings from DB
...
class Campings extends React.Component {
  ...
  componentDidMount() {
    ...
    url = "http://proj.ruppin.ac.il/bgroup77/prod/api/participant/meetings?email=" + this.state.email;
  ...
  getMeetings() {
    //AsyncStorage.setItem("subject", JSON.stringify(this.state.subject));
    subject = AsyncStorage.getItem("subject")
  }
    ...
    return (
      <View style={styles.tabs}>
        ...
        <View
          style={[
            styles.tab,
            filters.type === 'past' ? styles.activeTab : null
          ]}
        >
          <Text
            style={[
        ...
        return (
          <View key={`camping-${camping.id}`} style={styles.camping}>
            ...
            <Button
              ...
              titleStyle={{ fontWeight: 'bold', color: 'rgba(171, 189, 219, 1)' }}
            />
            {/* <ImageBackground
            ...
            <View style={styles.campingDetails}>
              ...
              <View style={{ flex: 1, flexDirection: 'row', }}>
                <View style={styles.campingInfo}>
                  <FontAwesome name="clock-o" color="black" size={12} />
                  <Text style={{ marginLeft: 4, color: 'black' }}>{camping.rating}</Text>
                </View>
                <View style={styles.campingInfo}>
                  <FontAwesome name="info" color="black" size={12} />
                  <Text style={{ marginLeft: 4, color: 'black' }}>{camping.distance}</Text>
                </View>
                <View style={styles.campingInfo}>
                  <FontAwesome name="calendar" color="black" size={12} />
